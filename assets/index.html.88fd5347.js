import{_ as l,r as c,o as p,c as u,d as a,w as t,a as n,b as s}from"./app.0d98b0a2.js";const i={},r=n("h2",{id:"项目开始",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#项目开始","aria-hidden":"true"},"#"),s(" 项目开始")],-1),k=n("ul",null,[n("li",null,[s("项目 主要由 "),n("code",null,"koa2 + sequelize + mysql"),s(" 简单博客项目")]),n("li",null,[n("code",null,"koa2 koa-pure-blog"),s(" 生成项目")])],-1),d=n("div",{class:"language-json line-numbers-mode","data-ext":"json"},[n("pre",{class:"language-json"},[n("code",null,[n("span",{class:"token punctuation"},"{"),s(`
